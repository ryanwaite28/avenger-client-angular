...
import { COMMON_EVENT_TYPES } from 'src/app/enums/all.enums';
import { PlainObject } from 'src/app/interfaces/common.interface';
import { IUser } from 'src/app/interfaces/avenger.models.interface';
import { ServiceMethodResultsInfo } from 'src/app/interfaces/common.interface';
...
export class UserConversationsComponent implements OnInit, OnDestroy {
  ...
  setConversation(conversation: any) {
    ...
    this.modelClient.user.update_conversation_last_opened(this.you.id, this.currentConversationSelected.id)
      .subscribe((response: ServiceMethodResultsInfo) => {
